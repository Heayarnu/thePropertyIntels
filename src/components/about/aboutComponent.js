    ...
    <section className="py-[6.44rem]">
      <div className="flex items-center gap-[3.31rem]">
        <div>
          ...
          <h3 className="mt-[.94rem] mb-[.62rem] text-[2.375rem] tracking-[-0.0475rem] font-bold text-main_heading">
            About ThePropertyIntels
          </h3>
          <p className="text-[1.125rem] tracking-[-0.0225rem] leading-[2rem] font-normal text-sub_heading">
          ...
          <button className="w-[11.3125rem] rounded-[6.25rem] p-[0.625rem] border-[rgba(255,255,255,0.91)] text-[1.125rem] tracking-[-0.0225rem] mt-[2.5rem] text-white font-semibold bg-primary border border-solid">
            Learn more
          </button>
        </div>
        <div className="relative h-[35.375rem] w-full">
          <Image
            className=""
            // width={3840}
            // height={2160}
