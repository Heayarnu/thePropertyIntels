export const membershipData = [
	{
		...
		details: [
			...
			{
				title: 'Reports',
				content: '2x Property status reports (every 6 months)',
			},
			{ title: 'Investment Sessions', content: '❌' },
			{ title: 'AirBnB Support', content: '❌' },
			{ title: 'Consultant Access', content: '❌' },
			{
	...
	},
	{
		...
		details: [
			...
			{ title: 'AirBnB Support', content: 'Included' },
			{ title: 'Consultant Access', content: '❌' },
			{
				title: 'HNIs Conferences',
				content: '❌',
	...
	},
	{
		...
		details: [
			...
			{ title: 'Investment Sessions', content: 'Quarterly' },
			{ title: 'AirBnB Support', content: 'Included' },
			{ title: 'Consultant Access', content: 'Dedicated Property Consultant' },
			{
				title: 'HNIs Conferences',
				content: 'Access to HNIs Investment Conferences',
			},
		],
	},
];
