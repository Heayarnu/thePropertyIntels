...
const GetStartedComponent = () => {
	...
	return (
		<section className="sm:grid grid-cols-2 justify-items-center max-w-screen-2xl mx-auto transform -translate-x-[80px]">
			...
			<div className="pt-8 flex items-start justify-start">
				<div className='flex flex-col justify-center xl:gap-4'>
					...
					{MenuList.map(([item, fc], index) => (
						<button
							key={index}
							className="text-base text-white leading-[1.8125rem] tracking-[-0.02rem] font-normal bg-[#166BBF] lg:w-[25rem] md:w-[22.35rem] sm:w-[17rem] p-2 my-3 w-[90vw] xl:w-[30rem]"
			...
			<div className="xl:mt-[3.44rem] relative h-[20.375rem] xl:h-[27.375rem] w-full basis-[45%] sm:border-l-2 sm:pl-5 xl:pl-10 2xl:pl-32 border-gray-400 flex items-center justify-center mt-10 sm:mt-[8rem] md:mt-[5rem]">
				<iframe
