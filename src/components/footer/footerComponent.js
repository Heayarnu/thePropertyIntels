...
import {FooterSocials, footerLogo,TERMS_OF_SERVICE_CONTENT,PRIVACY_POLICY_CONTENT,COOKIES_POLICY_CONTENT} from "./footerData";
...
function FooterComponent() {
  ...
  const FooterMenuList = [
    ...
    ["Terms of Service", "#Terms",() => openPopup("Terms of Service", TERMS_OF_SERVICE_CONTENT)],
    ["Privacy Policy", "#Terms",() => openPopup("Privacy Policy", PRIVACY_POLICY_CONTENT)],
    ["Cookies Policy", "#Terms",() => openPopup("Cookies Policy", COOKIES_POLICY_CONTENT)],
  ];
      ...
      <div className="relative">
        ...
        <div className="lg:flex justify-between items-center ">
          ...
          <p className="text-footer text-base leading-[1.25rem] font-normal max-lg:text-center ">
           ...
           <p className="text-footer text-base leading-[1.25rem] font-normal max-lg:text-center ">
           Powered by Philip Edge
            Africa
          </p>
             <img src="/assets/images/footer/pe.jpg" alt="phillip-edge"  className=" h-[35px]"/>
           </div>
          </div>
